...
class Metric {
   ...
   */
  def eventsPerProducer(q: Query, c: EventConsumer, outputEvents: Int): Map[EventProducer, Double] = {
   ...
   * @return An estimation of the total number of events generated by the producers.
   */
  protected def eventsPerProducer(q: Query, producerWeights: Map[EventProducer, Double], c: EventConsumer, outputEvents: Int):
